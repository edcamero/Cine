...
-- tabla intermedia entre cine y pelicula

create table cine_pelicula(
	id serial,
	idcine int not null,
	idpelicula int not null,
	CONSTRAINT PK_cine_peli PRIMARY KEY (id),
	CONSTRAINT FK_cine_r FOREIGN KEY (IDCINE) REFERENCES CINE(IDCINE),
	CONSTRAINT FK_pelis_r FOREIGN KEY (idpelicula) REFERENCES pelicula(idpelicula)
)
